...
!function(t, e) {
	...
	var o,
		...
		P = function(t) {
			...
			var i = {
				...
				getSelectorFromElement: function(e) {
					...
					"#" === i.charAt(0) && (
						n = i, i = n = "function" == typeof t.escapeSelector
		...
		R = (m = "button", E = "." + (
		v = "bs.button"), T = ".data-api", y = (p = e).fn[m], C = "active", I = "btn", A = "focus", b = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = "input", w = ".active", N = ".btn", O = {
				...
				I = function() {
					...
					I.hide = function(e) {
						...
						s.isDefaultPrevented() || (
							t(i).removeClass(p), "ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), this._activeTrigger[y] = !1, this._activeTrigger[T] = !1, this._activeTrigger[E] = !1, P.supportsTransitionEnd() && t(this.tip).hasClass(g)
					...
					I._leave = function(e, n) {
						...
						n._isWithActiveTrigger() || (
							clearTimeout(n._timeout), n._hoverState = d, n.config.delay && n.config.delay.hide
							? n._timeout = setTimeout(function() {
