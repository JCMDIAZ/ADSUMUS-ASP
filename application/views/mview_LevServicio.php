    ...
    <form action="Levantamiento_servicio" method="POST">
        <div class="row">
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <input type="text" class="form-control" id="folio" name="folio" placeholder="Folio del servicio">
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <input type="email" class="form-control" id="correo_solicitante" name="correo_solicitante" placeholder="you@example.com">
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <input type="text" class="form-control" id="telefono_solicitante" name="telefono_solicitante" >
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <select class="form-control" id="ejecutivo_asignado" name="ejecutivo_asignado" >
                <?php foreach($ejecutivo as $tipo){ ?>
                    <option value="<?php echo $tipo->Valor ?>"><?php echo $tipo->Descripcion ?></option>
                    <?php }?>
                </select>
            </div>
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <textarea class="form-control" id="material_utilizado" name="material_utilizado" >
                </textarea>
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
                <label for="fecha_cita_posterior">Fecha cita posterior</label>
                <input type="date" class="form-control" id="fecha_cita_posterior" name="fecha_cita_posterior" >
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
                <label for="fecha_hora_inicio">Fecha y Hora de Inicio</label>
                <input type="datetime-local" class="form-control" id="fecha_hora_inicio" name="fecha_hora_inicio" >
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
                <label for="fecha_hora_terminado">Fecha y Hora de Terminado</label>
                <input type="datetime-local" class="form-control" id="fecha_hora_terminado" name="fecha_hora_terminado" >
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
