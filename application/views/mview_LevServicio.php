    ...
    <form action="Levantamiento_servicio" method="POST">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <input type="date" class="form-control" id="elaboracion" name="elaboracion" disabled>
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
            ...
            <div class="col-md-4 col-sm-6 mb-3">
                ...
                <input type="datetime-local" class="form-control" id="fecha_hora_inicio" name="fecha_hora_inicio" disabled>
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
                <label for="fecha_hora_terminado">Fecha y Hora de Terminado</label>
                <input type="datetime-local" class="form-control" id="fecha_hora_terminado" name="fecha_hora_terminado" disabled>
            </div>
            <div class="col-md-4 col-sm-6 mb-3">
